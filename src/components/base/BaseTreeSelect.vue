 ...
 * @LastEditors: yanxin
 * @LastEditTime: 2020-04-10 14:04:08
 -->
<template>
    <div>
        <el-select ref="select" v-bind="$attrs" :multiple="multiple" v-on="$listeners" @change="valueChange">
            <el-option
            ...
            <el-input v-model="filterText" placeholder="输入关键字搜索" size="mini" class="search-input"></el-input>
            <el-tree
                ref="treeBox"
                :data="data"
                :props="defaultProps"
